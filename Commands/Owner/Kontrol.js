...
module.exports = {
    ...
    async execute(client, message, args, embed) {
        ...
        const totalTagges = message.guild.members.cache.filter(member => member.user.displayName.includes(botConfig.server.tag) || member.user.discriminator === botConfig.server.discrimTag && !member.roles.cache.has(botRoles.Register.tagRoles)).size
        ...
        collector.on("collect", async (interaction) => {
            ...
            switch (interaction.customId) {
                ...
                case "untagges":
                    ...
                    let tagges = message.guild.members.cache.filter(member => member.user.displayName.includes(botConfig.server.tag) || member.user.discriminator === botConfig.server.discrimTag && !member.roles.cache.has(botRoles.Register.tagRoles))
